...
const response=await axios.delete(`http://localhost:5000/api/employee/${id}`,{withCredentials:true})
...
const response=await axios.get(`http://localhost:5000/api/employee/approvalofemployee/${id}`,{withCredentials:true})
console.log(response?.data)
setSuccess(response?.data?.msg)
}catch(err){
